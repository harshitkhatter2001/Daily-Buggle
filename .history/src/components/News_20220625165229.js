...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title=`${this.capitaliseFirstLetter(this.props.category)} - DailyBugle`;
  }

  async updateNews() {
    this.props.setProgress(10);
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=42b05d5913aa4ad79ff3f3702c8f6d85&page=${this.state.page}&pagesize=${this.props.pageSize}`;
