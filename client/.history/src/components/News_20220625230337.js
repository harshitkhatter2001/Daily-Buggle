...
const News = () => {
  ...
  async updateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=22fea0eea0984e459aec1aec7cb6e806&page=${this.state.page}&pagesize=${this.props.pageSize}`;
